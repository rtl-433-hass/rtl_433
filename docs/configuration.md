...
are added and ignored — see [Adding Devices to Home
Assistant](device-discovery.md) — and it carries a **Signal coverage** page and
four settings pages. The split follows the topology: a setting about *sensors*
belongs to the location, and a setting about *one radio* belongs to its receiver.
