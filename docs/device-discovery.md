...
restart or a reload of the receiver, and fills again as devices transmit. A sensor
...
with the receiver and come back with their entities and history on every start.
