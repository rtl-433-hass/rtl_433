...
async def test_restore_state_on_skipped_for_motion_sensor(hass, receiver_entry_builder):
...
async def test_restore_state_off_applied_for_motion_sensor(
    hass, receiver_entry_builder
):
...
async def test_restore_state_off_from_extra_data_for_motion_sensor(
    ...
    assert hass.states.get(_motion_eid(hass, receiver)).state == "off"
...
async def test_restore_state_on_from_extra_data_dropped_for_motion_sensor(
    ...
    assert hass.states.get(_motion_eid(hass, receiver)).state == "unknown"
