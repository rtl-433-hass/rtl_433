...
| `18-rtl-433-page.png` | The **rtl_433 page** (`/rtl_433`), the overview Configure lands on: the status card reading Online with its device count, the My network rows out to this location's devices and entities, the three settings rows, and the Add or replace device button |
