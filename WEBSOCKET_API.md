...
configuration page, read and write the receiver's settings too.
...
| --- | --- | --- |
| `rtl_433/hubs` | — | Every configured receiver, loaded or not, with its connection. |
...
The receiver's [device-library overrides](docs/device-library.md), as the YAML text the
